...
//		}
	...
	if (p[18] != NULL && p[19] == NULL && (petri_controller_1_inputs[AUSLAUF_WERKSTUECK] == true)&& (fehler == false)) {
	...
	if (p[19] != NULL && (petri_controller_1_inputs[AUSLAUF_WERKSTUECK] == false)&& (fehler == false)) {
